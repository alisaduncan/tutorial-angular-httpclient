...
describe('UserService', () => {
  ...
  describe('getting all users', () => {
    it('returns users with an id <= 5',
      inject([HttpClient, HttpTestingController, UserService], (http: HttpClient, httpMock: HttpTestingController, userService: UserService) => {
        const mockResponse = [
          {
            id: 5,
            name: 'Test5',
    ...
    it('returns User[] mapped to correct properties',
      inject([HttpClient, HttpTestingController, UserService], (http: HttpClient, httpMock: HttpTestingController, userService: UserService) => {
        const mockResponse = [
          {
            id: 1,
